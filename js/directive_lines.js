lines.directive("segmentBuilderGroupL", function() {
    return {
        restrict: "E",
        replace: true,
        scope: {
        ...
        controller: function($scope, $rootScope, SegmentBuilder, $http) {
          //$scope.parts =[0];
            ...
            $scope.addElement = function(type, name, element) {
              ...
              newElem = SegmentBuilder.getNewGroup(newPosition, name, type);
...
lines.directive("segmentBuilderElement", function($compile) {
    return {
        restrict: "E",
        replace: true,
        scope: {
...
lines.directive("drag", function($rootScope, $timeout) {
  return {
    restrict: 'A',
    link: function(scope, element, attrs)  {
...
lines.directive("dropTarget", function($rootScope, $timeout, SegmentBuilder) {
  return {
    restrict: 'E',
    replace: true,
    scope: true,
